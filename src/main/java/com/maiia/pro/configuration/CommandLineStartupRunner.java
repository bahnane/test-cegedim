...
public class CommandLineStartupRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            //create practitioner
            Practitioner practitioner = practitionerRepository.save(
                    Practitioner.builder().firstName("practitioner" + i).lastName("maiia").build());
            ...
            TimeSlot timeSlot1 = TimeSlot.builder().startDate(LocalDateTime.of(2021, 2, 8, 8, 0))
                                         .endDate(LocalDateTime.of(2021, 2, 8, 12, 0))
                                         .practitionerId(practitioner.getId()).build();
            ...
            TimeSlot timeSlot2 = TimeSlot.builder().startDate(LocalDateTime.of(2021, 2, 8, 14, 0))
                                         .endDate(LocalDateTime.of(2021, 2, 8, 17, 0))
                                         .practitionerId(practitioner.getId()).build();
            ...
            TimeSlot timeSlot3 = TimeSlot.builder().startDate(LocalDateTime.of(2021, 2, 9, 9, 0))
                                         .endDate(LocalDateTime.of(2021, 2, 9, 17, 0))
                                         .practitionerId(practitioner.getId()).build();
            ...
            if (i % 2 == 0) {
                ...
                TimeSlot timeSlot4 = TimeSlot.builder().startDate(LocalDateTime.of(2021, 2, 10, 9, 0))
                                             .endDate(LocalDateTime.of(2021, 2, 10, 16, 0))
                                             .practitionerId(practitioner.getId()).build();
            ...
            if (i == 3) {
                ...
                TimeSlot timeSlot5 = TimeSlot.builder().startDate(LocalDateTime.of(2021, 2, 11, 11, 0))
                                             .endDate(LocalDateTime.of(2021, 2, 11, 18, 0))
                                             .practitionerId(practitioner.getId()).build();
            ...
            proAvailabilityService.saveAvailabilities(availabilities);
        }
